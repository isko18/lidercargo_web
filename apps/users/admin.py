...
class UserAdmin(admin.ModelAdmin):
    list_display = ("full_name", "phone", "is_employee", "pickup_point", "client_code", "is_active")
    list_filter = ("is_employee", "pickup_point", "is_active", "is_staff", "is_superuser")
    search_fields = ("full_name", "phone", "email", "client_code", "lc_number")
    ...
    fieldsets = (
        ...
        # ✅ убрали region_code
        ("LC", {"fields": ("lc_number", "client_code", "rack", "cell")}),
        ("Права", {"fields": ("groups", "user_permissions")}),
        ("Служебное", {"fields": ("last_login", "date_joined", "updated_at")}),
    )

    readonly_fields = ("date_joined", "updated_at", "client_code")
...
class ClientCodeCounterAdmin(admin.ModelAdmin):
    ...
    search_fields = ("pickup_point__name_ru", "pickup_point__branch_code")
